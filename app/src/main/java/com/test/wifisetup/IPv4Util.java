...
public class IPv4Util {
	...
	public static void main(String[] args) throws Exception {
		...
		Log.d("", "IP: " + ipAddr + " ByInet --> byte[]: [ " + byteStr
				+ " ]");
		...
		Log.d("",ipAddr1 + " , " + ipMask1 + "  --> int地址段 ：[ "
				+ ipscope1[0] + "," + ipscope1[1] + " ]");
		Log.d("",ipAddr1 + " , " + ipMask1 + "  --> IP地址段 ：[ "
